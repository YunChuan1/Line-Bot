...
// 「臺北市開放認養動物」API存取
const (
	OpenDataURL string = "http://rate.bot.com.tw/xrt?Lang=zh-TW"
...
type TaipeiPets struct {
	Result struct {
		text-right display_none_print_show print_width  int    'json:"text-right display_none_print_show print_width"'
